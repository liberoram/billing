...
<html lang="en">
<head>
  <title>Libero Ram 97905 27572</title>
  <meta charset="utf-8">
      ...
      function islogin() {
       ...
       var pass = $("#password").val().trim();
        ...
        $.ajax({
          ...
          type: 'POST',
          data: { islogin: 'islogin', uid: uid,pass:pass },
          success: function(response) {
            const product = JSON.parse(response);
            if(product.result=="Invalid")
            {
              alert("Please enter valid username / password");
            }
            else if(product.result=="valid")
            {
        ...
        <div class="modal-body">
          <div class="login-detail">
            <div class="login-form p-0">
              <div class="col-lg-12 mx-auto">
                <form id="login-form">
                  ...
                  <input type="password" name="password" id="password" placeholder="Password" class="ps-3 text-input">
            ...
            <div class="modal-footer mt-5 d-flex justify-content-center">
              <button type="button" class="btn btn-red hvr-sweep-to-right dark-sweep" onclick="islogin()">Login</button>
              <!-- <button type="button"
         ...
         <!--  <div class="col d-none d-md-block">
          ...
          <div class="col">
            <ul class="d-flex justify-content-end gap-3 list-unstyled m-0">
              ...
              $basePath = '/ram/hotel/v1/'; // Adjust based on your setup
              $currentUrl = str_replace($basePath, '', $_SERVER['REQUEST_URI']);
              $menuItems = [
                'Billing' => 'index.php'
              ];
              ...
              {
                $menuItems['Add Product'] = 'additems.php';
                $menuItems['Add Waiter'] = 'listofwaiter.php';
                 $menuItems['Search'] = 'search.php';
               }
               else
               {
                 $menuItems['Search'] = 'search.php';
              ...
              foreach ($menuItems as $name => $url): ?>
                  <li class="nav-item">
                  <a class="nav-link <?= ($currentUrl === $url) ? 'active' : '' ?>" href="<?= $url ?>"><?= ucfirst($name) ?></a>
                </li>
              <?php endforeach; 
